	...
	return (
		<div className="space-y-8">
			<div>
				...
				<p className="text-sm text-slate-400">Manage your account security and authentication</p>
			</div>
			...
			<div className="space-y-4">
				...
				>
					<div className="text-left">
						<div className="font-medium text-sm text-white group-hover:text-indigo-400 transition-colors">
							Change Password
						</div>
			...
			<div className="space-y-4">
				...
				<div className="p-4 bg-[#020617] border border-white/10 rounded-xl">
					...
					<button
						...
						className="w-full px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-500 transition-colors font-medium text-sm"
					>
