                      ...
                      <div className="mb-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <label className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer opacity-50">
                            <input type="radio" name="theme" value="dark" disabled className="text-blue-600" />
                            <div>
                              <div className="font-medium text-sm">Dark <span className="text-xs text-gray-400">(Coming Soon)</span></div>
                              <div className="text-xs text-gray-500">Easy on the eyes</div>
                            </div>
                          </label>
                          <label className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer opacity-50">
                            <input type="radio" name="theme" value="auto" disabled className="text-blue-600" />
                            <div>
                              <div className="font-medium text-sm">Auto <span className="text-xs text-gray-400">(Coming Soon)</span></div>
                              <div className="text-xs text-gray-500">Matches system theme</div>
                            </div>
                          </label>
                        </div>
                      </div>
