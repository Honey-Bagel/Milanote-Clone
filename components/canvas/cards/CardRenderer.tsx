 ...
 */
export function CardRenderer({ card, boardId, isEditing, isSelected, isPublicView, allCards, onEditorReady, onHeightChange, options }: CardRendererProps) {
	switch (card.card_type) {
		...
		case 'column':
			return <ColumnCardComponent card={card} isEditing={isEditing} isSelected={isSelected} allCards={allCards} />;
